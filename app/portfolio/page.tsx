...
import { Sparkles, Rocket, Users, Code, TrendingUp, ArrowRight, ExternalLink } from "lucide-react";
...
const PortfolioPage = () => {
  ...
  const ownProjects = [
    {
      title: "Iconfy",
      description: "Der einfachste Weg, perfekte App-Icons zu erstellen. Von Entwicklern für Entwickler.",
    ...
    {
      title: "Startseite",
      description: "Willkommen auf der Startseite von DevDanny – entdecke innovative Entwickler-Tools, spannende Projekte und Ressourcen.",
  ...
  const clientProjects = [
    {
      ...
      description: "Professionelle Autoaufbereitung in Hamburg – Glanz, Sauberkeit und Werterhalt mit Leidenschaft und Präzision.",
  ...
  const partnerships = [
    {
      title: "Protein Crew",
      description: "Kochrezepte der Influencer - Eine erfolgreiche Food-Community mit tausenden aktiven Nutzern.",
  ...
  const stats = [
    { value: "20+", label: "Projekte umgesetzt", color: "text-cyan-400", icon: "🚀" },
    { value: "15K+", label: "Nutzer erreicht", color: "text-purple-400", icon: "👥" },
    { value: "40%", label: "Durchschn. Conversion", color: "text-amber-400", icon: "📈" },
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-24 pb-20 relative overflow-hidden">
      ...
      <div className="floating-element absolute top-40 right-20 animate-float" style={{ animationDelay: '2s' }}>
        <div className="group relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="group inline-flex items-center mb-6 px-6 py-3 bg-cyan-500/10 border border-cyan-500/30 rounded-2xl backdrop-blur-sm transition-all duration-300 hover:bg-cyan-500/20 hover:scale-105">
            ...
            <span className="text-lg font-semibold text-cyan-400">✨ Portfolio Highlights</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
            Eine Auswahl meiner <span className="text-cyan-400 font-semibold">innovativsten Projekte</span> - 
            von eigenen Entwicklungen über Kundenaufträge bis hin zu strategischen{" "}
            <span className="text-purple-400 font-semibold">Partnerschaften</span>.
          </p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
            {stats.map((stat, index) => (
              ...
              >
                <div className={`text-2xl font-black ${stat.color} mb-2 transition-all duration-300 group-hover:animate-bounce`}>
                  {stat.value}
                </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="own" className="mt-0 space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-cyan-400 mb-4">🚀 Innovation & Growth</h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Eigene Projekte mit Fokus auf skalierbare Technologien und nachhaltiges Wachstum.
              </p>
            </div>
          ...
          <TabsContent value="clients" className="mt-0 space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-amber-400 mb-4">💼 Kunden Erfolge</h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Maßgeschneiderte Lösungen für Unternehmen - von Konzeption bis zur erfolgreichen Umsetzung.
              </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <TabsContent value="partnerships" className="mt-0 space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-purple-400 mb-4">🤝 Strategische Partnerschaften</h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Langfristige Kooperationen mit Fokus auf gemeinsamen Erfolg und Wachstum.
              </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="text-center mt-20 p-8 rounded-3xl bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-amber-500/10 border border-cyan-500/20 backdrop-blur-sm">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Lass uns zusammen etwas Großartiges erschaffen. Ob eigenes Projekt, Kundenauftrag oder strategische Partnerschaft - ich helfe dir bei der Umsetzung.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-500 hover:to-purple-500 border-0 text-white py-6 px-8 rounded-2xl group transform hover:scale-105 transition-all duration-300">
              <a href="/contact">
            ...
            <Button asChild size="lg" variant="outline" className="border-2 border-amber-400 text-amber-400 hover:bg-amber-400 hover:text-white py-6 px-8 rounded-2xl group transform hover:scale-105 transition-all duration-300">
              <a href="/partnerships">
