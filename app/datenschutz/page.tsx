...
import { Mail, Phone, Shield, Lock, Eye, FileText, UserCheck, Server, GlassesIcon, AlertTriangle, TrendingUp, Search, ExternalLink } from "lucide-react"
...
const dataProcessingSections = [
  {
    ...
    description: "Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert.",
  ...
  },
  {
    ...
    description: "Unser Hosting-Provider erhebt und speichert automatisch Informationen in Server-Log-Dateien, die Ihr Browser automatisch übermittelt. Diese Daten sind für den technischen Betrieb der Website erforderlich.",
    dataPoints: [
  ...
  },
  {
    ...
    description: "Diese Website nutzt Vercel Analytics zur Analyse des Nutzerverhaltens. Das Tool arbeitet vollständig anonymisiert und erfasst keine personenbezogenen Daten.",
    features: [
  ...
  },
  {
    ...
    description: "Wir verwenden Google Analytics 4 mit erweiterter Datenschutzkonfiguration zur Analyse der Website-Nutzung. Die Daten werden pseudonymisiert und eine vollständige Anonymisierung ist aktiviert.",
    features: [
    ...
    optOut: "Sie können die Erfassung durch Google Analytics verhindern, indem Sie das Cookie-Consent-Tool deaktivieren oder das Browser-Add-on zur Deaktivierung von Google Analytics installieren."
  },
  {
    icon: <Search className="w-5 h-5" />,
    title: "Google Search Console",
    description: "Wir nutzen Google Search Console zur Überwachung der technischen Performance unserer Website in den Google-Suchergebnissen. Dies dient der Verbesserung unserer Sichtbarkeit und der Identifikation technischer Probleme.",
    features: [
    ...
    legalBasis: "Art. 6 Abs. 1 lit. f DSGVO",
    retention: "16 Monate",
    purpose: "Verbesserung der Suchmaschinenoptimierung und technischen Website-Qualität",
    privacyNote: "Die Daten in Google Search Console sind aggregiert und nicht auf individuelle Nutzer zurückführbar."
  },
  {
    icon: <Shield className="w-5 h-5" />,
    title: "Cookie-Consent-Management",
    description: "Wir verwenden ein Cookie-Consent-Tool zur Verwaltung Ihrer Einwilligungen für datenschutzrelevante Funktionen. Ihre Präferenzen werden gespeichert, um bei jedem Besuch konsistent angewendet zu werden.",
    features: [
  ...
  const userRights = [
    {
      ...
      description: "Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten"
    },
    {
      icon: <FileText className="w-5 h-5" />,
    ...
    },
    {
      ...
      description: "Recht auf Löschung Ihrer personenbezogenen Daten („Recht auf Vergessenwerden“)"
    },
    {
      icon: <Lock className="w-5 h-5" />,
      title: "Einschränkungsrecht",
      description: "Recht auf Einschränkung der Verarbeitung Ihrer personenbezogenen Daten"
    },
    {
      icon: <Server className="w-5 h-5" />,
      title: "Datenübertragbarkeit",
      description: "Recht auf Übertragbarkeit Ihrer Daten in einem strukturierten, gängigen Format"
    },
    {
      icon: <AlertTriangle className="w-5 h-5" />,
      title: "Widerspruchsrecht",
      description: "Recht auf Widerspruch gegen die Verarbeitung Ihrer personenbezogenen Daten"
    }
  ]
  ...
  const securityFeatures = [
    {
      ...
      description: "Diese Seite nutzt aus Sicherheitsgründen eine SSL-bzw. TLS-Verschlüsselung. Eine verschlüsselte Verbindung erkennen Sie an 'https://' und dem Schloss-Symbol."
    },
    {
      icon: <Shield className="w-5 h-5" />,
      title: "Datenschutz durch Design",
      description: "Privacy by Design und Privacy by Default sind Grundprinzipien unserer Datenverarbeitung."
    },
    {
      icon: <Server className="w-5 h-5" />,
      title: "Sichere Hosting-Infrastruktur",
      description: "Unsere Server befinden sich in sicheren Rechenzentren innerhalb der EU mit höchsten Sicherheitsstandards."
    }
  ]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Transparente Informationen zum Umgang mit Ihren personenbezogenen Daten gemäß DSGVO
          </p>
        </div>
        ...
        <Card className="border-slate-700 bg-slate-900/50 backdrop-blur-sm hover:border-amber-500/30 transition-all duration-500 group relative overflow-hidden mb-12">
          ...
          <CardContent className="relative z-5 space-y-6">
            {dataProcessingSections.map((section, index) => (
              <div key={index} className="p-4 rounded-xl bg-slate-800/50 border border-slate-700 backdrop-blur-sm">
                <div className="flex items-start gap-4 mb-4">
                  <div className="p-2 bg-slate-700/50 rounded-lg">
                    {section.icon}
                  </div>
                  <div>
                    <h4 className="font-semibold text-lg text-white mb-2">{section.title}</h4>
                ...
                {section.dataPoints && (
                  <div className="ml-12 mb-3">
                    <h5 className="font-medium text-cyan-400 text-sm mb-2">Erhobene Daten:</h5>
                ...
                {section.features && (
                  <div className="ml-12 mb-3">
                    <h5 className="font-medium text-purple-400 text-sm mb-2">Features:</h5>
                    <ul className="text-gray-300 text-sm space-y-1">
          ...
          <CardContent className="relative z-5">
            <div className="grid md:grid-cols-2 gap-4">
              {userRights.map((right, index) => (
                <div key={index} className="p-4 rounded-xl bg-slate-800/50 border border-slate-700 backdrop-blur-sm hover:border-cyan-500/30 transition-all duration-300 group/item">
          ...
          <CardContent className="relative z-5">
            <div className="grid gap-4">
              {securityFeatures.map((feature, index) => (
                <div key={index} className="p-4 rounded-xl bg-slate-800/50 border border-slate-700 backdrop-blur-sm hover:border-amber-500/30 transition-all duration-300 group/item">
                  <div className="flex items-start gap-3">
        ...
        <div className="text-center mt-12">
          <p className="text-gray-400 mb-6">
            Haben Sie Fragen zu Ihren Datenschutzrechten oder zur Datenverarbeitung?
          </p>
