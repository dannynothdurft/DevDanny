...
import { Github, Linkedin, Mail, Twitter, Rocket, Sparkles, ArrowRight, Zap } from "lucide-react"
...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-slate-800 bg-slate-900/95 backdrop-blur-xl mt-20 relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 leading-relaxed max-w-md mb-6">
              Ich transformiere Ideen in <span className="text-cyan-400 font-semibold">wertvolle digitale Assets</span>. 
              Durch strategische Partnerschaften, App-Acquisitions und technische Expertise 
              erschaffen wir gemeinsam nachhaltigen Business-Erfolg.
            </p>
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6 backdrop-blur-sm">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <h4 className="text-white font-semibold">Bereit für dein nächstes Projekt?</h4>
              </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                { href: "/partnerships", label: "Alle Modelle", color: "text-cyan-400" },
                { href: "/equity", label: "Equity Partnership", color: "text-cyan-300" },
                { href: "/revenue", label: "Revenue Share", color: "text-purple-300" },
                { href: "/acquisition", label: "Project Acquisition", color: "text-amber-300" }
              ].map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="text-center lg:text-left">
              <p className="text-sm text-gray-400">
                ...
                <span className="text-cyan-400">Building digital assets with passion.</span>
              </p>
            </div>
