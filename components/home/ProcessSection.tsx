  ...
  const processSteps = [
    {
      ...
      description:
        'Wir besprechen dein Projekt, Ziele und Potenzial. Kostenlose Erstanalyse deiner Möglichkeiten.',
    ...
    },
    {
      ...
      description:
        'Entwicklung einer maßgeschneiderten Partnerschafts- oder Akquisitions-Strategie.',
    ...
    },
    {
      ...
      description:
        'Ich bringe die technische Expertise - du das Domain-Knowhow. Gemeinsam zum Erfolg.',
    ...
    },
    {
      ...
      description:
        'Kontinuierliche Optimierung, Skalierung und Wertsteigerung deines digitalen Assets.',
  ...
  return (
    <section className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-0 right-0 w-96 h-96 bg-orange-500/5 rounded-full blur-3xl animate-pulse"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-white">
            Vom ersten Gespräch zum{' '}
            <span className="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">
              erfolgreichen Exit
            </span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Ein transparenter, erprobter Prozess der sicherstellt dass wir
            maximale Ergebnisse erzielen -
            ...
            {processSteps.map((step, index) => (
              ...
              >
                ...
                <div className="lg:hidden absolute top-10 left-1/2 transform -translate-x-1/2 w-0.5 h-8 bg-amber-500/30 -bottom-8">
                  <div
                    className={`absolute inset-0 bg-amber-500 transition-all duration-500 ${activeStep === index ? 'opacity-100' : 'opacity-0'}`}
                  ></div>
                </div>

                {/* Step Card */}
                <div
                  className={`relative p-6 bg-slate-800/50 border rounded-2xl backdrop-blur-sm transition-all duration-500 h-full flex flex-col items-center lg:items-start group-hover:border-amber-500/50 group-hover:bg-slate-800/80 group-hover:-translate-y-2 ${
                    activeStep === index
                ...
                >
                  ...
                  <div className="flex items-center justify-between w-full mb-6">
                    <div
                      className={`w-12 h-12 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-2xl flex items-center justify-center text-amber-400 border border-amber-500/30 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 ${
                  ...
                  <div
                    className={`space-y-2 w-full transition-all duration-500 overflow-hidden ${
                      activeStep === index
                  ...
                  {/* Hover Indicator */}
                  <div
                    className={`absolute -top-2 -right-2 w-4 h-4 bg-amber-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              <Link href="/portfolio">Erfolgsgeschichten ansehen</Link>
            </Button>
          </div>
