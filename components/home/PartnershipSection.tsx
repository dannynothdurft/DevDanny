...
import { ArrowRight, Users, Sparkles, Gem, Target, DollarSign, MessageCircle } from "lucide-react"
...
const PartnershipSection = () => {
    const partnershipModels = [
  {
    ...
    description: "Ich werde dein technischer Mitgründer und baue dein Produkt von 0 auf. Perfekt für die frühe Phase.",
  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    <div className="text-center mb-16">
      <div className="inline-flex items-center mb-4 px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full">
        ...
        <span className="text-sm text-cyan-400 font-medium">Partnership Options</span>
      </div>
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-white">
        Wähle dein <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Partnerschafts-Modell</span>
      </h2>
      <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
        Drei Wege zur erfolgreichen Zusammenarbeit - maßgeschneidert für deine Bedürfnisse und Projekt-Phase.
      </p>
    </div>
          ...
          <div className="relative bg-slate-800/60 border border-slate-700 rounded-2xl p-8 backdrop-blur-sm transition-all duration-500 group-hover:border-cyan-500/50 group-hover:bg-slate-800/80 group-hover:-translate-y-3 h-full flex flex-col">
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 rounded-full group-hover:scale-110 transition-transform duration-300">
                <span className="text-cyan-400 text-sm font-bold">{model.percentage}</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <h4 className="text-sm font-semibold text-cyan-400 uppercase tracking-wide">Ideal für:</h4>
              </div>
              <div className="space-y-3">
                {model.bestFor.map((item, i) => (
                  ...
                  >
                    <div className="w-2 h-2 bg-green-400 rounded-full mr-3 animate-pulse" style={{ animationDelay: `${i * 0.2}s` }} />
                    {item}
                  </div>
                ))}
              </div>
    ...
    <div className="text-center mt-16">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Button asChild variant="outline" className="border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-white">
          <Link href="/contact">
