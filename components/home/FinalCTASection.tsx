...
import { ArrowRight, Sparkles, Rocket, Zap, Target, Calendar, CheckCircle2, Star } from "lucide-react"
...
const FinalCTASection = () => {
  ...
  const benefits = [
    { icon: <Target className="w-4 h-4" />, text: "Kostenlose Potenzial-Analyse" },
  ...
  return (
    <section ref={ctaRef} className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-amber-500/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`relative bg-gradient-to-br from-slate-800/80 via-slate-800/60 to-slate-900/80 border border-cyan-500/30 rounded-3xl p-8 sm:p-12 lg:p-16 text-center backdrop-blur-xl transition-all duration-1000 ${
          ...
          <div className="absolute top-4 right-4 w-3 h-3 bg-purple-400 rounded-full opacity-60 animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute bottom-4 left-4 w-3 h-3 bg-amber-400 rounded-full opacity-60 animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute bottom-4 right-4 w-3 h-3 bg-cyan-400 rounded-full opacity-60 animate-pulse" style={{ animationDelay: '3s' }}></div>
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center mb-6 px-4 py-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 rounded-full backdrop-blur-sm">
              ...
              <span className="text-sm text-cyan-400 font-semibold">Let's Build Something Amazing</span>
            </div>

            {/* Main Headline */}
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-white leading-tight">
              Bereit für deinen nächsten
              <span className="bg-gradient-to-r from-cyan-400 via-purple-400 to-amber-400 bg-clip-text text-transparent"> Erfolg?</span>
            </h2>

            {/* Subheadline */}
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Egal ob <span className="text-cyan-400 font-semibold">Partnerschaft</span>, <span className="text-purple-400 font-semibold">Projekt-Verkauf</span> oder <span className="text-amber-400 font-semibold">Neustart</span> - 
              gemeinsam finden wir den besten Weg dein digitales Asset aufzubauen.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              ...
              >
                <Link href="/contact">
                  ...
                  <span className="relative z-10">🚀 Jetzt Strategie-Gespräch buchen</span>
            ...
            <div className="mt-8 p-4 bg-slate-800/50 rounded-2xl border border-slate-700 backdrop-blur-sm">
              <p className="text-sm text-gray-400">
                <span className="text-cyan-400 font-semibold">⚡ Schnell & Fokussiert:</span> In unserem Gespräch identifizieren wir sofort 
                dein größtes Potenzial und entwickeln eine klare Strategie für dein nächstes Digital Asset.
              </p>
            </div>
          </div>
        </div>
