...
const PartnershipsPage = () => {
  ...
  const partnershipModels = [
    {
      ...
      description:
        'Ich werde dein Tech-Co-Founder und baue dein Produkt von 0 auf 1. Perfekt für die frühe Phase.',
      bestFor: [
  ...
  const activeModelData = partnershipModels.find(
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              Gemeinsam bauen wir nicht nur Produkte, sondern{' '}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">
              Wähle dein{' '}
              <span className="text-cyan-400">Partnerschafts-Modell</span>
            </h2>
                        ...
                        <div key={index} className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-gray-400 text-sm mt-1">
                              {activeModelData.timeframe} •{' '}
                              {activeModelData.commitment}
                            </p>
                          </div>
                        </div>
                      ))}
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">
              Bewährte{' '}
              <span className="text-green-400">Erfolgsgeschichten</span>
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-amber-500/10 border border-cyan-500/30 rounded-2xl p-12 text-center relative overflow-hidden glow-cyan">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">
                Bereit für deine{' '}
                <span className="text-cyan-400">nächste Partnerschaft</span>?
              </h2>
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                Lass uns in 30 Minuten analysieren, welches Modell am besten zu
